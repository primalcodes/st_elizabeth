...
module Spina
  module Pages
    class MenuPresenter
      ...
      config_accessor :list_tag, :list_tag_css, :list_wrapper, :list_wrapper_css, :list_item_tag, :list_item_css, :selected_css, :current_css, :first_css, :last_css
      ...
      def render_list_wrapper(menu_items)
        if menu_items.any?
          if list_wrapper
            content_tag(:div, class: list_wrapper_css) do
